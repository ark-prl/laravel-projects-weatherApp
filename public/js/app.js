...
var app = new Vue({
  ...
  mounted: function mounted() {},
  methods: {
    moveToTokyo: function moveToTokyo() {
      currentLocation = "Tokyo";
      this.getDate();
      this.getWeather();
      this.getPlaceInfo();
    },
    moveToYokohama: function moveToYokohama() {
      currentLocation = "Yokohama";
      this.getWeather();
      this.getDate();
      this.getPlaceInfo();
    },
    moveToKyoto: function moveToKyoto() {
      currentLocation = "Kyoto";
      this.getWeather();
      this.getDate();
      this.getPlaceInfo();
    },
    moveToOsaka: function moveToOsaka() {
      currentLocation = "Osaka";
      this.getWeather();
      this.getDate();
    },
    moveToSapporo: function moveToSapporo() {
      currentLocation = "Sapporo";
      this.getWeather();
      this.getDate();
    },
    moveToNagoya: function moveToNagoya() {
    ...
    getWeather: function getWeather() {
      ...
      var url = "https://cors-anywhere.herokuapp.com/https://api.openweathermap.org/data/2.5/weather?q=".concat(currentLocation, "&appid=090ffa7befe18ad28164de751f87ab2e");
    ...
    getPlaceInfo: function getPlaceInfo() {
      ...
      var client_id = "5SJCQ5O1NYTI35GEVLTYDQ0RZMZUOBW2ZZFZOJ3TQPQVCLP0";
      var client_secret = "XFGQBAVJPCDLAJNJT2J1GFYXZKVNO0L1USPQNKHJ0H0UQ53K";
      var categoryId = "50aa9e094b90af0d42d5de0d";
      var version = "20191209";
      var url = "https://cors-anywhere.herokuapp.com/https://api.foursquare.com/v2/venues/search?client_id=".concat(client_id, "&client_secret=").concat(client_secret, "&near=").concat(currentLocation, "&v=").concat(version, "&categoryId=").concat(categoryId);
      axios.get(url).then(function (response) {
        _this2.longitude = response.data.response.geocode.feature.geometry.center.lng;
        _this2.latitude = response.data.response.geocode.feature.geometry.center.lat;
      });
    },
...
__webpack_require__(/*! C:\Users\Arthur\Desktop\Laravel blade\BMWeather\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Arthur\Desktop\Laravel blade\BMWeather\resources\sass\app.scss */"./resources/sass/app.scss");
